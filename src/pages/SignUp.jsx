...
const SignUp = () => {
  ...
  const [{ email, password, confirmPassword }, setForm] = useState({
    // firstName: "",
    // lastName: "",
    email: "",
    password: "",
  ...
  // Redirect the user to the sign in page if everything goes alright

  if (redirect) return <Navigate to="/signin" />;

  // Render form for signing up
  ...
  return (
    <form
      ...
      <button
        className="cursor-pointer bg-gradient-to-r from-fuchsia-600 to-purple-600 text-white px-6 py-2 rounded-full shadow hover:from-purple-700 hover:to-indigo-700 self-center"
        disabled={loading}>
        Create Account
      </button>
    </form>
